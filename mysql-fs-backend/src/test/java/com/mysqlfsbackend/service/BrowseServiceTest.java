...
public class BrowseServiceTest {
    ...
    void testGetDirectoryFromPath() {
        DirectoryEntity root = new DirectoryEntity("0", "root", null, 0, "1", "1", 0);
        DirectoryEntity dirA = new DirectoryEntity("1", "A", "0", 1, "1", "1", 0);
        DirectoryEntity dirB = new DirectoryEntity("2", "B", "1", 1, "1", "1", 0);
    ...
    void testGetFileFromPath() {
        ...
        DirectoryEntity dirA = new DirectoryEntity("1", "A", "0", 1, "1", "1", 0);
        DirectoryEntity dirB = new DirectoryEntity("2", "B", "1", 1, "1", "1", 0);
        FileEntity fileA = new FileEntity("0", "A", "2", 1, "1", "1", 3, FileTypes.NONE,"lol");
    ...
    void testBrowseDirectory() {
        DirectoryEntity root = new DirectoryEntity("0", "root", null, 0, "1", "1", 12);
        DirectoryEntity dirA = new DirectoryEntity("1", "A", "0", 1, "1", "1", 6);
        DirectoryEntity dirB = new DirectoryEntity("2", "B", "1", 1, "1", "1", 3);
        FileEntity fileA = new FileEntity("3", "A", "1", 1, "1", "1", 3, FileTypes.NONE,"lol");
        FileEntity fileB = new FileEntity("4", "B", "1", 1, "1", "1", 3, FileTypes.NONE,"lol");
        FileEntity fileC = new FileEntity("5", "C", "2", 1, "1", "1", 3, FileTypes.NONE,"lol");
        FileEntity fileD = new FileEntity("6", "D", "0", 1, "1", "1", 3, FileTypes.NONE,"lol");
